...
TOKEN = '7391753730:AAHCmUvNracLmZ-0HkKMld-whRMYK2vYz4I'
...
FORWARD_CHANNEL_ID = -1002216217595
CHANNEL_ID = -1002216217595
error_channel_id = -1002216217595
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/xteam007/10599*", parse_mode='Markdown')
